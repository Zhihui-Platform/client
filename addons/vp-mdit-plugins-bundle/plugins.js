...
var require_main = __commonJS({
  "node_modules/.pnpm/vscode-textmate@6.0.0/node_modules/vscode-textmate/release/main.js"(exports, module2) {
    !function(e, t) {
...
// src/node/markdown/plugins/index.ts
var plugins_exports = {};
__export(plugins_exports, {
  containerPlugin: () => containerPlugin,
  highlight: () => highlight,
  highlightLinePlugin: () => highlightLinePlugin,
...
var linkPlugin = (md, externalAttrs, base) => {
  ...
  function normalizeHref(hrefAttr, env) {
    ...
    if (indexMatch) {
      ...
      const parsed = new import_url.URL(url, "http://a.com");
...
var snippetPlugin = (md, srcDir) => {
  const parser = (state, startLine, endLine, silent) => {
    ...
    token.src = import_path.default.resolve(filename) + region;
    token.markup = "```";
  ...
  md.renderer.rules.fence = (...args) => {
    ...
    if (src) {
      ...
      const isAFile = import_fs.default.lstatSync(src).isFile();
      if (import_fs.default.existsSync(src) && isAFile) {
        let content = import_fs.default.readFileSync(src, "utf8");
        if (regionName) {
